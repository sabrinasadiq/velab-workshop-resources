##############################################################################################
################### ABUNDANCE, ALPHA DIVERSITY, AND BETA DIVERSITY SCRIPTS ###################
################## Refined by Sabrina Sadiq over 5 years of trial and error ##################
#################### Virus Ecology Statistics Workshop pt. 1 - 25/03/2026 ####################
##############################################################################################
...
# Set working directory and import data for quick glimpse figures
...
# Environment  5 0.20278 0.040557  8.6883 3.515e-05 ***
summary(glht(m.env,linfct = mcp(Environment="Tukey")))
# CN - CC == 0 -0.114080   0.039446  -2.892   0.0697 .  
# SN - CC == 0 -0.126240   0.039446  -3.200   0.0347 *  
# SP - CC == 0 -0.199701   0.039446  -5.063   <0.001 ***
# VC - CC == 0 -0.199359   0.039446  -5.054   <0.001 ***
# VN - CC == 0 -0.219418   0.039446  -5.562   <0.001 ***
...
# Soil_type  2 0.14634 0.073172   12.29 0.0001026 ***
summary(glht(m.type,linfct = mcp(Soil_type="Tukey")))
# Sodosol - Chromosol == 0  -0.10593    0.03150  -3.363  0.00556 ** 
# Vertosol - Chromosol == 0 -0.15235    0.03150  -4.836  < 0.001 ***
# Vertosol - Sodosol == 0   -0.04642    0.03150  -1.474  0.31643  
...
# Depth      1 0.059461 0.059461  7.1346 0.01152 *
...
# Model  1: Abundance ~ Environment + Depth
# Model  2: Abundance ~ Soil_type + Land_use + Depth
# Model  3: Abundance ~ Soil_type + Depth
# Model  4: Abundance ~ Land_use + Depth
# Model  5: Abundance ~ Soil_type + Land_use
# Model  6: Abundance ~ Environment
# Model  7: Abundance ~ Soil_type
# Model  8: Abundance ~ Land_use_broad
# Model  9: Abundance ~ Land_use
# Model 10: Abundance ~ Depth
...
# Model 1: Abundance ~ Environment + Depth
# Model 2: Abundance ~ Environment
# Res.Df      RSS Df Sum of Sq  Pr(>Chi)    
# 1     29 0.080579                           
# 2     30 0.140040 -1 -0.059461 3.728e-06 *** depth needed
...
# Trying some extra models because (spoiler alert) Land_use_broad was also significant for richness
