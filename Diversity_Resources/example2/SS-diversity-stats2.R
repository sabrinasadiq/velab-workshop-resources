...
#################### Virus Ecology Statistics Workshop pt. 2 - 25/03/2026 ####################
##############################################################################################
...
# Model     2   0.6988 0.1666 2.8986  0.012 *

bd.temp <- betadisper(soil_bray, sampledf$Temperature)
anova(bd.temp)
# Groups     2 0.21044 0.105222  8.5856 0.001179 **
TukeyHSD(bd.temp)
# -80°C--30°C  0.14434040  0.02595306  0.2627278 0.0143581
# 2-8°C--30°C -0.03243874 -0.16914068  0.1042632 0.8286318
# 2-8°C--80°C -0.17677915 -0.29516650 -0.0583918 0.0025912 **

# Collection month
vegan::adonis2(soil_bray ~ Collected, data = sampledf)
# Model     1   1.9884 0.47403 27.038  0.001 ***
bd.month <- betadisper(soil_bray, sampledf$Collected)
anova(bd.month)
# Groups     1 0.01077 0.010770  0.9484 0.3379
